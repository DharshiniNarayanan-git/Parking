export const occupiedIconSVG1 = `
<svg viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg">

<defs>

<!-- ✅ Updated Red Gradient -->
<radialGradient id="metallicRedSphereGradient" cx="50%" cy="50%" r="50%">
  <stop offset="10%" style="stop-color:#f87171; stop-opacity:1" />
...
<!-- Bottom Dot -->
<circle cx="50" cy="200" r="5" fill="#fca5a5" />
