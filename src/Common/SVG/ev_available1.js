export const ev_available1 = `
<svg viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg">

<defs>

<!-- ✅ Teal Metallic Sphere -->
<radialGradient id="metallicTealSphereGradient" cx="50%" cy="50%" r="50%">
...
<!-- ✅ Teal Top Circle -->
<circle cx="50" cy="50" r="40" fill="url(#metallicTealSphereGradient)" filter="url(#shadow)" />
...
<!-- Bottom Dot -->
<circle cx="50" cy="200" r="5" fill="#5eead4" />
